...
private:
    ...
    SuperPlot *Fftcanvas                                = nullptr;
    QVector<SuperPlot*> Canvasqvector                   = {};
    ...
    QFile *File                                         = nullptr;
    ReadWav *Threadra                                   = nullptr;
    PlayWav *Threadpa                                   = nullptr;
    ToFft *Threadta                                     = nullptr;
