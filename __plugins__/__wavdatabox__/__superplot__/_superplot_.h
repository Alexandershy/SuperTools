...
#define QCPPAINTER__EXPORT Q_DECL_EXPORT
#define QCUSTOMPLOT__EXPORT Q_DECL_EXPORT
#define QCPLAYERABLE__EXPORT Q_DECL_EXPORT
#define QCPLAYOUTELEMENT__EXPORT Q_DECL_EXPORT
#define QCPLAYOUT__EXPORT Q_DECL_EXPORT
#define QCPDATARANGE__EXPORT Q_DECL_EXPORT
#define QCPDATASELECTION__EXPORT Q_DECL_EXPORT
#define QCPAXIS__EXPORT Q_DECL_EXPORT
#define QCPAXISRECT__EXPORT Q_DECL_EXPORT
#define QCPAXISPAINTERPRIVATE__EXPORT Q_DECL_EXPORT
#define QCPABSTRACTPLOTTABLE__EXPORT Q_DECL_EXPORT
#define QCPGRAPH__EXPORT Q_DECL_EXPORT
#define QCPABSTRACTITEM__EXPORT Q_DECL_EXPORT
#define QCPLEGEND__EXPORT Q_DECL_EXPORT
#define QCPITEMPOSITION__EXPORT Q_DECL_EXPORT
#define QCPABSTRACTLEGENDITEM__EXPORT Q_DECL_EXPORT
#define QCPSELECTIONRECT__EXPORT Q_DECL_EXPORT
#define QCPCOLORMAP__EXPORT Q_DECL_EXPORT
#define QCPCOLORSCALE__EXPORT Q_DECL_EXPORT
#define QCPBARS__EXPORT Q_DECL_EXPORT
#define QCPPOLARAXISRADIAL__EXPORT Q_DECL_EXPORT
#define QCPPOLARAXISANGULAR__EXPORT Q_DECL_EXPORT
#define QCPPOLARGRID__EXPORT Q_DECL_EXPORT
#define QCPPOLARGRAPH__EXPORT Q_DECL_EXPORT
...
class QCPPainter;
class QCUSTOMPLOT__EXPORT QCustomPlot;
class QCPLAYERABLE__EXPORT QCPLayerable;
class QCPLayoutElement;
class QCPLayout;
class QCPDATARANGE__EXPORT QCPDataRange;
class QCPAXIS__EXPORT QCPAxis;
class QCPAxisRect;
class QCPAxisPainterPrivate;
class QCPABSTRACTPLOTTABLE__EXPORT QCPAbstractPlottable;
class QCPGRAPH__EXPORT QCPGraph;
class QCPAbstractItem;
class QCPPlottableInterface1D;
class QCPLegend;
class QCPITEMPOSITION__EXPORT QCPItemPosition;
class QCPLayer;
...
/*! \internal
  ...
  \see getMarginValue
*/
static inline void setMarginValue(QMargins &margins, QCP::MarginSide side, int value)
{
  switch (side)
  {
...
/*! \internal
  ...
  \see setMarginValue
*/
static inline int getMarginValue(const QMargins &margins, QCP::MarginSide side)
{
  switch (side)
  {
...
class QCP_LIB_DECL QCPDATASELECTION__EXPORT QCPDataSelection
{
public:
